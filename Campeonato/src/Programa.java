...
public class Programa {
	public static void main(String[] args) {
		...
		System.out.println("");
		System.out.println("----------------- Informações do time da casa -----------------");
		System.out.println("Nome do clube: " + equipe1.getNome());
		System.out.println("Técnico: " + equipe1.getTecnico().getNome());
